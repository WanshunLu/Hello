...
def add_moves(pokemon, moves_list):
    ...
    index = randint(1, len(moves_list) - 1)
...
def main():
    ...
    while True:
        ...
        if usr_inp != 'y':
            ...
            if ch.isdigit():
                player_pokemon = choose_pokemon(int(ch), pokemon_list)
            else:
            ...
            if ch.isdigit():
                opponent_pokemon = choose_pokemon(int(ch), pokemon_list)
            else:
            ...
            # start battle
            curr_player_num = player_num
            go = True
            while go:
                go = turn(curr_player_num, player_pokemon, opponent_pokemon)
                curr_player_num = 1 if curr_player_num == 2 else 2
                player_pokemon, opponent_pokemon = opponent_pokemon, player_pokemon
